...
### Making sure your commits conform to the Conventional Commits format

All commits **must** be in the [Conventional Commits format](../../uno-development/git-conventional-commits.md).

We use this to automatically generate release notes for new releases, this means that your commit messages will appear untouched in the release notes.
...
- Squash your commits, using interactive rebase:
   ...
   git push -f
   ```
- If your fixing a regression introduced by a PR that as not been released yet, use `fix(reg): Fixing issue of previous PR`
